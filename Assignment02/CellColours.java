...
public class CellColours {
	...
	public static final Color JEWEL = Color.BLUE;
	public static final Color UNVISITED = new Color(100, 255, 100);
	public static final Color IN_STACK = Color.CYAN;
	public static final Color JEWEL_PROCESSED = new Color(0, 190, 190);
	public static final Color JEWEL_POPPED = new Color(255, 255, 255);
