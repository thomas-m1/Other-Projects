...
public class CellComponent extends JComponent  {
	...
	private String imgJewel = "ruby.jpg";
	private String imgJewelPushed = "ruby_pushed.jpg";
	private String imgJewelPopped = "ruby_popped.jpg";
	...
	protected void paintComponent(Graphics g) {
		...
		if (c == CellColours.BLOCK) {
		...
		} else if (c == CellColours.JEWEL_PROCESSED || c == CellColours.INITIAL_PROCESSED
				|| c == CellColours.INITIAL_POPPED || c == CellColours.JEWEL_POPPED) {
			// Initial and destination cells when they have been reached
			displayed = true;
			Image img;
			if (c == CellColours.JEWEL_PROCESSED || c == CellColours.INITIAL_PROCESSED)
			...
			g2d.setPaint(gp);
			g2d.fillPolygon(cellPoly);
			if (c == CellColours.JEWEL_PROCESSED) {
				img = new ImageIcon(imgJewelPushed).getImage();
				...
				g2d.drawImage(img, 0, 0, width, width, null);
			} else if (c == CellColours.JEWEL_POPPED) {
				img = new ImageIcon(imgJewelPopped).getImage();
				g2d.drawImage(img,  0,  0,  width,  width,  null);
			} else {
			...
			g2d.setPaint(gp);
			g2d.fillPolygon(cellPoly);
			img = new ImageIcon(imgJewel).getImage();
			//g2d.drawImage(img, width / 5, height / 5, 3 * width / 5, 3 * height / 5, null);
			g2d.drawImage(img, 0, 0, width, width, null);
