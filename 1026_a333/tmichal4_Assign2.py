...
# Assignment 2 -  How to Invest Your Money?
# February 27th, 2019
...
def main():
    ...
    for i in range(1000): # repeats code 1000 times
     ...
     for times_machine_2 in range(10):
         ...
         reward_list2.append(total_reward_machine_2)


    #finds total profit/loss, calculates total amount and cuts in half to invest
    ...
    #picks machine with greater profit
     ...
     rewardstotal = reward_list2 + reward_list1 + reward_list# adds lists together
